  ...
  <el-table
    ...
    <el-table-column
      ...
      <el-dialog ref="test" title="用户信息" :visible.sync="dialogTableVisible" :append-to-body="true">  <!-- 添加append-to-body才会显示弹框 -->
          ...
          <el-table-column property="machine_name" label="出售" width="200">
            
          </el-table-column>
          <el-table-column property="use_hours" label="使用时长（小时）" width="200">
  ...
  export default {
    ...
    methods: {
      ...
      getHomeInfo() {
        ...
        this.$axios.post("/api/v1/BuyyCar/maiche",{
